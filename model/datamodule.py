...
from model.checkpoint_utils import DATA_ROOT, dataset_paths_for_body
from model.dataset import GCSH5Dataset
...
class DatasetPaths:
    ...
    @staticmethod
    def for_body(body: str, data_root: str | Path = DATA_ROOT) -> "DatasetPaths":
