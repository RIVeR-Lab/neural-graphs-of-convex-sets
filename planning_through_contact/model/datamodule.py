...
class DatasetPaths:
    h5_path: str | Path = "planning_through_contact/dataset/data/gcs_solutions.h5"
...
class GCSDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        if stage in (None, "fit"):
            ...
            # If you later log a dedicated "val" split, change this.
            ...
            self._pos_weight = self._compute_pos_weight(self.ds_train)
