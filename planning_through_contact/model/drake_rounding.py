...
def round_from_predicted_flows(
    *,
    ...
    """
    Mimic `create_plans.py` rounding stack, but swap the relaxation result with predicted flows:
    ...
    if candidate_paths is None:
        return None
    feasible_paths = planner._get_rounded_paths(solver_params, list(candidate_paths))
...
def predict_edge_flows_for_planner(
    *,
    ...
    node_features_csv: str = "planning_through_contact/dataset/data/node_features.csv",
