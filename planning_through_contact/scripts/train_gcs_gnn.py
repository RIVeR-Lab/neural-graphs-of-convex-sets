...
from model.datamodule import DatasetPaths, GCSDataModule
from model.hparams import DecoderHParams, EncoderHParams, TrainingHParams
from model.lightning_module import GCSLightningModule
...
def main() -> None:
    ...
    parser.add_argument("--ckpt_dir", type=str, default=str(CHECKPOINT_ROOT), help="Where to save .ckpt files.")
    parser.add_argument(
        "--ckpt_filename",
        type=str,
        default=None,
