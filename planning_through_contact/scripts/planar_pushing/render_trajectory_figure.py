...
def main() -> None:
    ...
    paths = dataset_paths_for_body(args.body)
    flow_ckpt = flow_checkpoint_path(args.body)
    ranker_ckpt = ranker_checkpoint_path(args.body)
    node_feat_csv = str(paths.node_features_csv)
    plan_idx_csv = paths.global_features_csv
