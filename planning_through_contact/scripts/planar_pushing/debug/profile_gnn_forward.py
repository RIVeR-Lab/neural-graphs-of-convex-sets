...
Run from repo root: python3 planning_through_contact/scripts/planar_pushing/debug/profile_gnn_forward.py --ckpt_path checkpoints/gcs_gnn/last.ckpt [--num_runs 10] [--warmup 5]
"""
