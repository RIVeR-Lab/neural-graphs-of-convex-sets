"""Nonconvex GCS planning via Drake GcsTrajectoryOptimization (Wrangel et al.)."""
...
def solve_nonlinear_relaxation(graph, source_vertex, target_vertex):
    """Convex relaxation of the nonconvex GCS (same phase as BezierGCS rounding=True step 1)."""
...
def plan_nonlinear_gcs(
    ...
    *,
    ...
    """
    Shortest-path nonconvex GCS (accel limits + continuity through snap).
